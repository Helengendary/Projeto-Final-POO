...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException  {
        ...
        ArrayList<User> clientes = Serializacao.carregarCliente();
        ...
        while(dentro) {
            switch (locate) {
                ...
                case "5":
                    ...
                    int indexDonoAtual;
                    for(indexDonoAtual = 0; indexDonoAtual < Serializacao.sizeDonos(); ++indexDonoAtual) {
                        Serializacao.getDono(indexDonoAtual).verPerfil(indexDonoAtual);
                    }

                    indexDonoAtual = scan.nextInt();
                    scan.nextLine();

                    atual = Serializacao.getDono(indexDonoAtual);
                ...
                case "6":
                    ...
                    int indexLojaDono;
                    for(indexLojaDono = 0; indexLojaDono < Serializacao.sizeLojas(); ++indexLojaDono) {
                        System.out.println(indexLojaDono + " - " + (Serializacao.getDono(indexLojaDono)).getNome());
                    }

                    indexLojaDono = scan.nextInt();
                    scan.nextLine();

                    atual = new Dono(nomeDono, cpfDono, cepDono, numeroDono, Serializacao.getLoja(indexLojaDono));
                    System.out.println("Cadastrado e entrado como " + atual.getNome());
                    Serializacao.salvarDono(atual);
                ...
                case "8":
                    ...
                    Serializacao.salvarCliente(atualCliente, clientes);
                ...
                case "9":
                    ...
                    for(int i = 0; i < Serializacao.sizeLojas(); ++i) {
                        
                        System.out.println("Nome: " + Serializacao.getLoja(i).getNome());
                        Serializacao.getLoja(i).MostrarProdutos();
                        System.out.println("Total de vendas: " + Serializacao.getLoja(i).getTotalVendas() + "\n");
                    }
                ...
                case "10":
                    ...
                    Serializacao.salvarLoja(newLoja);
